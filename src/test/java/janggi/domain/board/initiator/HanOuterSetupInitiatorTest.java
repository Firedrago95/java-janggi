...
import static janggi.JanggiTestFixture.getHanFixedPieces;
import static org.assertj.core.api.Assertions.assertThat;

@ReplaceUnderBar
class HanOuterSetupInitiatorTest {

    private final SetupInitiator hanOuterSetupInitiator = new HanOuterSetupInitiator();

    @Test
    void 한나라_바깥상차림_기물들을_생성한다() {
        // when
        Map<Position, Piece> hanLeftSetupPieces = hanOuterSetupInitiator.generateInitialPieces();
